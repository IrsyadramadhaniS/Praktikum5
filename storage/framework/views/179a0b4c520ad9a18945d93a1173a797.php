...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.store')); ?>" method="POST" class="needs-validation" novalidate="">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName')); ?>" placeholder="Enter First Name" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="lastName" id="lastName" value="<?php echo e(old('lastName')); ?>" placeholder="Enter Last Name" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age" id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Age" required="">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Users\Irsyad\ProjectLaravel4\resources\views/employee/create.blade.php ENDPATH**/ ?>